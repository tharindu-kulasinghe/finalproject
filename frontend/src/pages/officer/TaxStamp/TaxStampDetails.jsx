  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<Button variant="outline" onClick={() => navigate('/officer/tax-stamps')}>Back to Tax Stamps</Button>} />
      

      <div className="text-sm text-gray-500">
        <Link to="/officer/tax-stamps" className="hover:text-gray-700">Tax Stamps</Link>
...
export default OfficerTaxStampDetails;