...
const OfficerRetailers = () => {
  ...
  },
  {
    ...
    <div className="flex gap-2">
          <Link to={`/officer/retailers/${row.id}`}>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Retailers"
        description="View retailer accounts and retail license applications" />
...
export default OfficerRetailers;