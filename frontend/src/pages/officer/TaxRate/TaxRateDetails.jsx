  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
        <Link to="/officer/tax-rates">
            <Button variant="outline" onClick={() => navigate('/officer/tax-rates')}>Back</Button>
          </Link>
        } />
      

      <div className="text-sm text-gray-500">
        <Link to="/officer/tax-rates" className="hover:text-gray-700">Tax Rates</Link>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 space-y-6">
          <div className="border border-gray-200 bg-white p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">1. Category and Status</h3>
          ...
          <div className="border border-gray-200 bg-white p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">3. Validity and Legal Basis</h3>
...
export default OfficerTaxRateDetails;