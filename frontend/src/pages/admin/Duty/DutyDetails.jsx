...
const DutyDetails = () => {
  ...
  const canUpdateStatus = duty && ['CALCULATED', 'PART_PAID', 'OVERDUE'].includes(duty.status);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button variant="danger" onClick={() => openStatusModal('cancel')}>
            ...
            <Button variant="outline" onClick={() => navigate('/admin/duties')}>
              Back
            </Button>
          </div>
        } />
      ...
      <div className="text-sm text-gray-500">
        <Link to="/admin/duties" className="hover:text-gray-700">Duties</Link>
      ...
      <div className="border border-gray-200 bg-white p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <Badge variant={getStatusColor(duty.status)}>{duty.status}</Badge>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-medium text-gray-900">{formatDate(duty.dueDate)}</p>
          </div>
          <div>
