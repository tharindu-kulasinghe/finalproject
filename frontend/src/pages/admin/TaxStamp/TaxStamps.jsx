...
const AdminTaxStamps = () => {
  ...
  },
  {
    ...
    header: 'Actions',
    render: (row) =>
    <Link to={`/admin/tax-stamps/${row.id}`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-gray-200 bg-white">
        ...
        <Table columns={columns} data={filtered} loading={loading} emptyMessage="No tax stamps found" />
      </div>
    </div>);

};

export default AdminTaxStamps;