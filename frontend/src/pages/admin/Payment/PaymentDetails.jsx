  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Review declared payment information and verification history"
        actions={
        <div className="flex flex-wrap gap-2">
            <Button variant="outline" onClick={() => navigate(`/admin/payments/${payment.id}/edit`)}>
              Edit Payment
            </Button>
            <Button variant="outline" onClick={() => navigate('/admin/payments')}>Back to Payments</Button>
          </div>
        } />
      

      <div className="text-sm text-gray-500">
        <Link to="/admin/payments" className="hover:text-gray-700">Payments</Link>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-amber-200 bg-amber-50 p-5">
              <p className="text-sm text-amber-800 font-medium">This payment can be edited and reviewed now.</p>
              <Button className="mt-3" onClick={() => navigate(`/admin/payments/${payment.id}/edit`)}>Go to Edit Page</Button>
            </div>
          }
        </div>
      </div>
