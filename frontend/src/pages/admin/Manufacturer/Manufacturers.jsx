...
const Manufacturers = () => {
  ...
  },
  {
    ...
    <div className="flex gap-2">
          <Link to={`/admin/manufacturers/${row.id}`}>
            <Button variant="outline" size="sm">View</Button>
          </Link>
          <Link to={`/admin/manufacturers/${row.id}/edit`}>
            <Button variant="outline" size="sm">Edit</Button>
          </Link>
          <Link to={`/admin/products?manufacturerId=${row.id}`}>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Manufacturers"
        description="Manage manufacturer accounts and manufacturing license applications"
        actions={
