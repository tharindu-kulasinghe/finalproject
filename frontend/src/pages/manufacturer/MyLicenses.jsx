...
const getLicenseType = (license) => license.type || license.licenseType || 'License';
...
const MyLicenses = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      userId ? manufacturerApi.getManufacturerLicenseApplication(userId) : Promise.resolve(null)]
      );
      ...
      console.error('Failed to load manufacturer license information:', error);
      setLicenses([]);
      setApplications([]);
    } finally {
      setLoading(false);
  ...
  },
  {
    ...
    render: (row) => row.manufacturingType || '-'
  },
  {
    key: 'status',
    header: 'Status',
    ...
    <div className="space-y-6">
      <PageHeader
        ...
        <div className="flex gap-2">
            <Link to="/manufacturer/apply-license">
      ...
      <div className="border border-gray-200 bg-white p-6">
        ...
        <div className="space-y-3">
            <p className="text-sm text-gray-600">No active manufacturing license found.</p>
            <Link to="/manufacturer/apply-license">
